...
iStim = ieStimulusGratingSubunit(paramsWN);
% iStim = ieStimulusBar(paramsWN);
% absorptions = iStim.sensor;
whiteNoise = iStim;
% testmovieshort = (iStim.sceneRGB(1:80,1:40,:,:));
testmovieshort = permute(iStim.sceneRGB(1:80,1:40,:,:), [2 1 3 4]);
...
% filename1 = ['/Users/james/Documents/MATLAB/EJLExperimentalRGC/Gratingresponse/prosthesis_off_parasol/Gratingstim_response_ProsOFFParasol4.mat'];
...
% filename1 = ['/Users/james/Documents/MATLAB/EJLExperimentalRGC/Gratingresponse/prosthesis_off_parasol/Barstim_response_ProsOFFParasol1.mat'];
% save(filename1, 'whiteNoiseSmall','spikesoutsm');

end
%%
locs=(vertcat(innerRetina.mosaic{1}.cellLocation{:}));

linmov = zeros(40,80,352);

for i = 1:length(locs)
  linmov(locs(i,1),locs(i,2),:) = squeeze(innerRetina.mosaic{1}.responseLinear(i,1,:));
end
figure; ieMovie(linmov);