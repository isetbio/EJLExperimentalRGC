...
% 
% This function is only called internally by rgcPhys, which itself is only
% called by irPhys.
% 
...
% Load mosaic from a physiology experiment
[mosaicGLM, goodind] = glmLoad(obj, 'cellType', cellType);

switch(averageFlag)
    
    % Convert loaded mosaic to rgcPhys format
    case 0        
